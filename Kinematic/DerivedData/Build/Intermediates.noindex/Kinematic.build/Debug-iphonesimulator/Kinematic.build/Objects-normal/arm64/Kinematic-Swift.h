...
#ifndef KINEMATIC_SWIFT_H
#define KINEMATIC_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="Kinematic",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
@class CLLocation;
SWIFT_CLASS("_TtC9Kinematic23LocationTrackingService")
@interface LocationTrackingService : NSObject <CLLocationManagerDelegate>
