...
struct LeadsListView: View {
    ...
    var body: some View {
        ...
        // The floating "+" FAB was removed at the user's request — the
        // toolbar "+" (below) is now the single add-lead entry point, and
        // it carries the guided-tour spotlight anchor.
